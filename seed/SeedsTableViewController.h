...
@interface SeedsTableViewController : UITableViewController <LocationControllerDelegate, EAIntroDelegate, UIGestureRecognizerDelegate, CreateSeedViewControllerDelegate>
